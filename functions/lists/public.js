/**
 * Tallinn Tastebuds — /lists/public, the directory.
 *
 ...
 * IT WAS /lists/kept
 *
 * The address said what the page was ordered by; the page is about what is on
 * it, which is every list anybody made public. functions/lists/kept.js is
 * still there and answers 301 to here, because the old address is in
 * sitemap.xml, in search results, and in whatever anybody pasted into a
 * message — an address that has been indexed is not a name you get to take
 * back, only one you get to forward.
 *
