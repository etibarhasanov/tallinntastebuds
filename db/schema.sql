...
-- the site ships with are not here at all: data/decks.json is sixteen decks
-- and three hundred and five cards of Estonian, deployed as a file and read as one,
